...
import { apiClient, apiServer } from '../utils/api'
...
export async function postData(): Promise<TestItem | null> {
  ...
  return apiClient
    .post<TestItemResponse>("test", {
      text: `sample text_${Math.ceil(Math.random() * 100)}`,
    })
    .then((res) => {
